...
description: "Configure scroll speed, flipping, margins, indicators and colors for the teleprompter display"
---
...
![The Display Settings screen](../resources/DisplaySettingsScreen.webp){.w-100}
...
![Default Scroll Speed slider](../resources/DisplaySettingsScrollSpeed.webp){.w-100}
...
![Default Flip X and Default Flip Y toggles](../resources/DisplaySettingsFlip.webp){.w-100}
...
![Enable Control Buttons toggle](../resources/DisplaySettingsControlButtonsEnable.webp){.w-100}

Control Buttons Position selects which side of the screen they're anchored to: left, right, top or bottom.

![Control Buttons Position dropdown](../resources/DisplaySettingsControlButtonsPosition.webp){.w-100}
...
![Display Reading Indicator Boxes toggle](../resources/DisplaySettingsReadingIndicators.webp){.w-100}

Height of Reading Indicator Boxes sets how tall those boxes are, as a percentage of the screen.

![Height of Reading Indicator Boxes slider](../resources/DisplaySettingsReadingIndicatorsHeight.webp){.w-100}
...
![Enable Vertical Margins toggle](../resources/DisplaySettingsVerticalMarginsEnable.webp){.w-100}

Height of Vertical Margins sets how large that band is.

![Height of Vertical Margins slider](../resources/DisplaySettingsVerticalMarginsHeight.webp){.w-100}
...
![Enable Fade for Vertical Margin toggle](../resources/DisplaySettingsFadeEnable.webp){.w-100}

Fade Length controls how far that fade extends.

![Fade Length slider](../resources/DisplaySettingsFadeLength.webp){.w-100}
...
![Side Margin slider](../resources/DisplaySettingsSideMargin.webp){.w-100}

Countdown Timer sets how many seconds pass between pressing play and the text starting to scroll.

![Countdown Timer slider](../resources/DisplaySettingsCountdown.webp){.w-100}
...
![Prompter Background Color picker](../resources/DisplaySettingsBackgroundColor.webp){.w-100}

Prompter Text Color sets the color of the scrolling text and the affordances of the app themselves.

![Prompter Text Color picker](../resources/DisplaySettingsTextColor.webp){.w-100}
