---
title: "Setup the App"
description: "Configure TiefPrompt's language, theme and primary color after installing"
---
...
![Instructions to open the TiefPrompt Settings](../resources/home_screen/OpenSettings.webp){.w-100}
...
![Instructions to change the TiefPrompt Language](../resources/main_settings_screen/ChangeLanguage.webp){.w-100}

## Theming

The apps theme is similarly configurable, this time to either be light, dark or system dependent.

![Instructions to change the TiefPrompt Theme](../resources/main_settings_screen/ChangeTheme.webp){.w-100}
...
![Instructions to change the TiefPrompt Primary Color and example of app afterwards](../resources/main_settings_screen/PrimaryColor.webp){.w-100}
