...
![Instructions to change the TiefPrompt Language](../resources/ChangeLanguage.webp){.w-100}

## Theming

The apps theme is similarly configurable, this time to either be light, dark or system dependent.

![Instructions to change the TiefPrompt Theme](../resources/ChangeTheme.webp){.w-100}
...
![Instructions to change the TiefPrompt Primary Color and example of app afterwards](../resources/ChangePrimaryColor.webp){.w-100}
