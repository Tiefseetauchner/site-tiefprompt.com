...
description: "Save, apply, export, import and delete named TiefPrompt settings profiles"
---
...
![Instructions to Save Settings](../resources/SaveSettings.webp){.w-100}

Once saved, you can also export or delete a settings profile by pressing the three buttons to the right of each profile:

![Instructions to Export Settings](../resources/ExportSettings.webp){.w-100}
...
![Instructions to Import Settings](../resources/ImportSettings.webp){.w-100}

To delete a profile, press the trashcan icon next to it and confirm.

![Instructions to Delete Settings](../resources/DeleteSettings.webp){.w-100}
